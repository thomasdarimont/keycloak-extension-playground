...
public class AdHocAuthenticatorFactory implements AuthenticatorFactory {

    private static final String PROVIDER_ID = "adhoc-demo-authenticator";
    ...
    public Authenticator create(KeycloakSession session) {
        return new AdHocAuthenticator(session);
    }
